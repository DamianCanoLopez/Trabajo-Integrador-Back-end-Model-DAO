...
public class DomicilioDaoH2 implements IDAO<Domicilio>{
    ...
    public Domicilio guardar(Domicilio domicilio) {
        LOGGER.info("Iniciando una operacion de guardado de un domicilio");
    ...
    public Domicilio buscar(Integer id) {
        LOGGER.info("Iniciando una operacion de busqueda de un domicilio con id= "+id);
        Connection connection=null;
    ...
    public void actualizar(Domicilio domicilio) {
        LOGGER.info("Iniciando una operacion de actualizacion de un domicilio con id= "+domicilio.getId());
        Connection connection=null;
        try {
            connection=BD.getConnection();
    ...
    public void eliminar(Integer id) {
        LOGGER.info("Iniciando una operacion de eliminacion de un domicilio con id= "+id);
        Connection connection=null;
        try {
            connection=BD.getConnection();
    ...
    public List<Domicilio> buscarTodos() {
        LOGGER.info("Iniciando una operacion de buequeda total de los domicilios");
        Connection connection=null;
